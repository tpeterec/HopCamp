...
function Host() {
    ...
    return (
      <div className="host-info-container">
       ...
       <Button variant="secondary" style={{backgroundColor:"transparent", border: "none", hover: "dark grey" }} onClick={closeModal} className="modal-close-button">X</Button>
         ...
         <Modal.Footer>
           <Button variant="secondary" onClick={handleOnClick} className="modal-send-button">
           Send message
           </Button>
         </Modal.Footer>
        </Modal>
