...
function Current_campsite()
{
    return (
        <div className={styles.currentCampSite}>
            ...
            <div id='rating'>
                <ol className="d-flex gap-1 align-items-center bg-secondary">
                    <li className='d-flex '>
                        <svg viewBox="0 0 512 512" height="16px" width="16px" xmlns="http://www.w3.org/2000/svg">
