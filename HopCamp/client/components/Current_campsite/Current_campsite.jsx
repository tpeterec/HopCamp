        ...
        <div className={styles.currentCampSite}>
            ...
            <div id='rating'>
                <ol className="d-flex gap-1 align-items-center ">
                    ...
                    <li className="fw-bold" role="button"><a href="#">190 reviews</a></li>
                    <span className='fw-bold fs-5'>·</span>
            ...
            <div id='buttonGroup'>
                <ol className="d-flex gap-3">
                    <button className={`ps-4 pe-4 fw-semibold text-white rounded-3 ${styles.btOrange}`}>See available sites</button>
                    <button className={`p-2 ps-4 pe-4 fw-semibold rounded-3 ${styles.btNormal}`}>
                    ...
                    <button className={`p-2 ps-4 pe-4 fw-bold rounded-3 ${styles.btNormal}`}>
