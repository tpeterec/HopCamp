...
function Camp_safety(){
    return (
        <div className="safety-component-container">
            <h1 className="safety-heading">Safety at Hopcamp</h1>
            <div className="safety-card-container">
                <div className="safety-card">
                    <div className="safety-card-content">
                        ...
                        ></img>
                        <img src="https://hipcamp-res.cloudinary.com/f_auto,c_limit,w_384,q_auto/hipcamp_hand_hexqba.png"
                ...
                <div className="safety-card">
                    ...
                    <a
                    className="safety-card-button"
                    href="https://www.hipcamp.com/en-US/hipcamperstandards"
                    >Learn More</a>
                </div>
            </div>
        </div>
